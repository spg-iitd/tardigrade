...
class AfterImage(BaseTrafficFeatureExtractor):
    ...
    def setup(self):
        """sets up after image"""
        super().setup()
        # TODO: why reset state is necessary?
        if self.reset_state:
            self.state = NetStat(
    ...
    def extract_features(self):
        ...
        features_list = []
        meta_list = []
        for packet in tqdm(self.input_pcap, desc=f"parsing {self.path}"):
            ...
            # TODO: why do we need to offset the time?
